...
from mmpose.datasets.datasets.face.lapa_dataset import LapaDataset
from mmpose.datasets.transforms.common_transforms import (
    Albumentation, GenerateTarget, GetBBoxCenterScale, PhotometricDistortion,
    RandomBBoxTransform, RandomFlip, RandomHalfBody)
...
train_cfg.merge(dict(max_epochs=max_epochs, val_interval=1))
