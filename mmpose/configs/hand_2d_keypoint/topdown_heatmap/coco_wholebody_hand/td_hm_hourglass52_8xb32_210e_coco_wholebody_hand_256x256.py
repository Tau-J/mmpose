...
from mmpose.datasets.datasets.hand.coco_wholebody_hand_dataset import \
...
from mmpose.evaluation.metrics.keypoint_2d_metrics import AUC, EPE, PCKAccuracy
from mmpose.models.backbones.hourglass import HourglassNet
...
# hooks
default_hooks.merge(dict(checkpoint=dict(save_best='AUC', rule='greater')))
...
train_pipeline = [
    ...
    dict(
        type=RandomBBoxTransform, rotate_factor=180.0,
