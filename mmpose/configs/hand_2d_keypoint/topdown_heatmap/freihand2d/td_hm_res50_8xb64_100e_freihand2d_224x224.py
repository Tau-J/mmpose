...
from mmpose.datasets.datasets.hand.freihand_dataset import FreiHandDataset
...
# runtime
train_cfg.merge(dict(max_epochs=100, val_interval=1))
...
# hooks
default_hooks.merge(
    dict(checkpoint=dict(save_best='AUC', rule='greater', interval=1)))
