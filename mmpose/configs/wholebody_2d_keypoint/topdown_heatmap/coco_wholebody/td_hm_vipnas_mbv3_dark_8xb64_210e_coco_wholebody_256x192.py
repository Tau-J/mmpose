...
from mmpose.datasets.datasets.wholebody.coco_wholebody_dataset import \
...
from mmpose.models.backbones.vipnas_mbv3 import ViPNAS_MobileNetV3
from mmpose.models.data_preprocessors.data_preprocessor import \
    PoseDataPreprocessor
from mmpose.models.heads.heatmap_heads.vipnas_head import ViPNASHead
...
# hooks
default_hooks.merge(
    dict(checkpoint=dict(save_best='coco-wholebody/AP', rule='greater')))
