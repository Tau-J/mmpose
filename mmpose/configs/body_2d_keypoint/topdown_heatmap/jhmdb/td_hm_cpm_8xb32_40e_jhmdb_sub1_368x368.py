...
from mmpose.datasets.datasets.body.jhmdb_dataset import JhmdbDataset
...
from mmpose.evaluation.metrics.keypoint_2d_metrics import JhmdbPCKAccuracy
...
# runtime
train_cfg.merge(dict(max_epochs=40, val_interval=1))
...
# hooks
default_hooks.merge(
    dict(checkpoint=dict(save_best='PCK', rule='greater', interval=1)))
