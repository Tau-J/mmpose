...
self_dis_model_cfg = 'configs/wholebody_2d_keypoint/rtmpose/wholebody8/wb_d0918rc2.py'  # noqa: E501
...
model = dict(
    ...
    two_dis=second_dis,
    teacher_pretrained='/mnt/petrelfs/jiangtao/wb8_exp/wb_d0919rc1/'
    's1.pth',  # noqa: E501
