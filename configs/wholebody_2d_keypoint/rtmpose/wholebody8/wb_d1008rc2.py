...
from mmpose.models import (CSPNeXt, CSPNeXtPAFPN, PoseDataPreprocessor,
                           RTMWHead, SimCCDISTLoss, TopdownPoseEstimator)
...
model = dict(
    ...
    head=dict(
        ...
        gau_cfg=dict(
            ...
            use_rel_bias=False,
            pos_enc=False),
        loss=dict(type=SimCCDISTLoss, use_target_weight=True, tau=1.),
        decoder=codec),
