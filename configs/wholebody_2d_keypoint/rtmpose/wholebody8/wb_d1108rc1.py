...
model = dict(
    ...
    teacher_pretrained='/mnt/petrelfs/jiangtao/wb8_exp/wb_d1017rc1/'
    'best_coco-wholebody_AP_epoch_190.pth',  # noqa: E501 E251
    teacher_cfg='configs/wholebody_2d_keypoint/rtmpose/wholebody8/'
    'wb_d1017rc1.py',  # noqa: E501
    student_cfg='configs/wholebody_2d_keypoint/rtmpose/wholebody8/'
    'wb_d1017rc2.py',  # noqa: E501
    distill_cfg=[
        dict(methods=[
            dict(
                type=FeaLoss,
