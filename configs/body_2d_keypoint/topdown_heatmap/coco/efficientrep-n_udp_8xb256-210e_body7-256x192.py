...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='https://download.openmmlab.com/mmyolo/v0/yolov6/'
            'yolov6_n_syncbn_fast_8xb32-400e_coco/'
            'yolov6_n_syncbn_fast_8xb32-400e_coco_20221030_202726-d99b2e82.pth'
        )),
    head=dict(
        type='HeatmapHead',
        in_channels=256,
